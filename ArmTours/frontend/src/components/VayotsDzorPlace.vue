<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Die Provinz Vayots Dzor hat viele spannende Sehenswürdigkeiten zu bieten. Von beeindruckenden Naturkulissen bis 
        hin zu historischen Stätten gibt es hier viel zu entdecken!
      </h1>
      <div class="content">
        <div class="left-box">
...
import { vayotsdzorplaceMixin } from '../mixins/vayotsdzorplaceMixin';

export default {
  name: 'VayotsDzorPlace',
  mixins: [vayotsdzorplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

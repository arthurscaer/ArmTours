<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Lori ist bekannt für ihre majestätischen Kirchen, die inmitten der malerischen Landschaft der armenischen Berge
        stehen.
        Diese ehrwürdigen Gotteshäuser erzählen von einer tiefen spirituellen Tradition und laden dazu ein, die
        friedvolle Atmosphäre zu genießen und die religiöse Kunst und Architektur zu bewundern.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { loriMixin } from '../mixins/loriMixin';

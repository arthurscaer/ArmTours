<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Aragatsotn ist reich an außergewöhnlichen Sehenswürdigkeiten, die es zu entdecken gilt. Von natürlichen Wundern bis hin zu 
        historischen Denkmälern – diese Orte erzählen die faszinierende Geschichte der Region und bieten unvergessliche Erlebnisse.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { aragatsotnplaceMixin } from '../mixins/aragatsotnplaceMixin';

export default {
  name: 'AragatsotnPlace',
  mixins: [aragatsotnplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Die Provinz Gegharkunik bietet eine faszinierende Mischung aus natürlichen und kulturellen Sehenswürdigkeiten. Von 
        atemberaubenden Landschaften am Ufer des Sees Sevan bis hin zu historischen Stätten und Denkmälern hat die Region 
        viel zu bieten und verspricht unvergessliche Erlebnisse für jeden Besucher.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { gegharkunikplaceMixin } from '../mixins/gegharkunikplaceMixin';

export default {
  name: 'GegharkunikPlace',
  mixins: [gegharkunikplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

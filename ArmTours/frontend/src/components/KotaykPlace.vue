<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Die Provinz Kotayk ist ein wahres Juwel für Reisende, die sowohl natürliche Schönheit als auch kulturelle Schätze entdecken 
        möchten. Von den spektakulären Ausblicken der Berglandschaft bis zu den historischen Sehenswürdigkeiten gibt es hier 
        zahlreiche Möglichkeiten, die reiche Geschichte und die atemberaubende Natur zu erleben.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { kotaykplaceMixin } from '../mixins/kotaykplaceMixin';

export default {
  name: 'KotaykPlace',
  mixins: [kotaykplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

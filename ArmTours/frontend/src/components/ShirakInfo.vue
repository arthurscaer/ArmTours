<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Shirak ist eine Provinz, die reich an Geschichte und kulturellem Erbe ist. Hier finden Sie beeindruckende Kirchen, 
        die nicht nur architektonische Meisterwerke sind, sondern auch bedeutende spirituelle Stätten darstellen. Die Atmosphäre 
        dieser heiligen Orte lädt dazu ein, in die tiefe religiöse Tradition Armeniens einzutauchen und die stille Schönheit 
      ...
      <div class="content">
        ...
        <div class="right-box">
          ...
          <p v-if="kirche.events_and_services"><strong>Veranstaltungen und Gottesdienste:</strong> {{
        ...
        <div class="upload-content">
          <div class="upload-box">
            ...
            <div class="name-input-container">
              ...
              <p class="name-input-hint">Geben Sie zuerst den Namen der Kirche ein, um das Bild zu speichern.</p>
            </div>
            <div class="square-button-container">
              <button @click="uploadImage" class="square-button upload-button" :disabled="!imageName">Bild
                hochladen</button>
            </div>
            <button @click="deleteChurch('selected', kirche.name)" class="delete-button">Kirche endgültig löschen</button>
            <div class="description-edit">
              ...
              <textarea v-model="kirche.events_and_services" placeholder="Veranstaltungen und Gottesdienste"
                class="input-field"></textarea>
      ...
      <div v-if="showPopup" class="popup-addchurch">
        <div class="popup-content-addchurch">
          <h2>Neue Kirche hinzufügen</h2>
          <input type="text" v-model="newChurchName" placeholder="Kirchenname" class="popup-input-addchurch" />
          ...
          <input type="text" v-model="newChurchRecommendedDuration" placeholder="Empfohlene Dauer"
            class="popup-input-addchurch" />
          <textarea v-model="newChurchEventsAndServices" placeholder="Veranstaltungen und Gottesdienste"
            class="popup-input-addchurch"></textarea>
...
import { shirakMixin } from '../mixins/shirakMixin';

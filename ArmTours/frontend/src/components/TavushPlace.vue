<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Tavush hat jede Menge interessante Sehenswürdigkeiten zu bieten. Hier kann man die atemberaubende Natur, alte Festungen 
...
import { tavushplaceMixin } from '../mixins/tavushplaceMixin';

export default {
  name: 'TavushPlace',
  mixins: [tavushplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

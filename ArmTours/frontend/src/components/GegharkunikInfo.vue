<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Gegharkunik ist bekannt für seine beeindruckenden Kirchen, die nicht nur architektonische Meisterwerke sind, sondern auch 
        tief in der spirituellen Tradition Armeniens verwurzelt. Diese historischen Stätten laden dazu ein, die religiöse und 
        kulturelle Geschichte der Region zu erkunden.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { gegharkunikMixin } from '../mixins/gegharkunikMixin';

export default {
  name: 'GegharkunikInfo',
  mixins: [gegharkunikMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

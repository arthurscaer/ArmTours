<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        In Shirak gibt es eine Vielzahl faszinierender Sehenswürdigkeiten, die sowohl die Geschichte als auch die Natur dieser 
        Region widerspiegeln. Von alten Festungen und Klöstern bis hin zu malerischen Landschaften und traditionellen Dörfern 
        gibt es zahlreiche Möglichkeiten, die reichen kulturellen und natürlichen Schätze Shiraks zu entdecken und zu erleben.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { shirakplaceMixin } from '../mixins/shirakplaceMixin';

export default {
  name: 'ShirakPlace',
  mixins: [shirakplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

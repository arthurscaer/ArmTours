<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Ararat bietet eine Fülle an faszinierenden Sehenswürdigkeiten, die einen Besuch wert sind. Von der majestätischen Natur bis 
        hin zu kulturellen Highlights – die Region lädt dazu ein, ihre Schätze zu entdecken und unvergessliche Eindrücke zu sammeln.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { araratplaceMixin } from '../mixins/araratplaceMixin';

export default {
  name: 'AraratPlace',
  mixins: [araratplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

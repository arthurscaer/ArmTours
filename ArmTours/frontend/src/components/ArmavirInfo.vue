<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Die Provinz Armavir beherbergt einige der ältesten und bedeutendsten Kirchen Armeniens. Diese spirituellen Stätten sind nicht 
        nur Orte des Glaubens, sondern auch Zeugnisse der langen Geschichte und reichen Kultur, die diese Region auszeichnet.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { armavirMixin } from '../mixins/armavirMixin';

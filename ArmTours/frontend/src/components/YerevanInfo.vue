<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        In Yerevan gibt es eine Vielzahl wunderschöner Kirchen, die nicht nur architektonische Meisterwerke sind, 
        sondern auch eine tiefe spirituelle Bedeutung haben. Lass dich von der Geschichte und dem Charme dieser Orte verzaubern!
      </h1>
      <div class="content">
        <div class="left-box">
...
import { yerevanMixin } from '../mixins/yerevanMixin';

<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        In der Provinz Syunik erwarten Sie beeindruckende Kirchen, eingebettet in malerische Berglandschaften. Diese heiligen 
        Stätten bieten nicht nur Einblicke in die spirituelle Vergangenheit Armeniens, sondern laden auch zu einer 
        besinnlichen Entdeckungstour ein.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { syunikMixin } from '../mixins/syunikMixin';

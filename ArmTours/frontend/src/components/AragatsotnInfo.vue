<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        In der Provinz Aragatsotn laden wir Sie ein, einige der bemerkenswertesten Kirchen zu erkunden. Diese heiligen Stätten bieten 
        faszinierende Einblicke in das spirituelle und architektonische Erbe der Region.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { aragatsotnMixin } from '../mixins/aragatsotnMixin';

export default {
  name: 'AragatsotnInfo',
  mixins: [aragatsotnMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

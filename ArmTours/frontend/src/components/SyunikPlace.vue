<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Syunik begeistert mit einer Vielzahl an Sehenswürdigkeiten, die die reiche Kultur und Geschichte der Region widerspiegeln. 
        Entdecken Sie historische Festungen, atemberaubende Landschaften und die herzliche Gastfreundschaft der Einheimischen.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { syunikplaceMixin } from '../mixins/syunikplaceMixin';

export default {
  name: 'SyunikPlace',
  mixins: [syunikplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        In Vayots Dzor findest du eine Reihe faszinierender Kirchen, die in einer malerischen Landschaft eingebettet sind. 
        Diese Orte laden dazu ein, die spirituelle Atmosphäre zu erleben und die einzigartige Architektur zu bewundern.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { vayotsdzorMixin } from '../mixins/vayotsdzorMixin';

export default {
  name: 'VayotsDzorInfo',
  mixins: [vayotsdzorMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        In der Provinz Tavush gibt es viele schöne Kirchen, die inmitten der grünen Wälder und sanften Hügel stehen. 
        Diese historischen Orte sind perfekt, um die ruhige Atmosphäre und die tolle Architektur zu genießen.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { tavushMixin } from '../mixins/tavushMixin';

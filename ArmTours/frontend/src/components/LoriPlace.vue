<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        In der Provinz Lori erwarten Sie atemberaubende Sehenswürdigkeiten, die Geschichte und Natur auf beeindruckende Weise verbinden. 
        Von den faszinierenden Klöstern und Burgen bis hin zu den malerischen Wanderwegen durch grüne Täler und an rauschenden 
        Flüssen entlang gibt es hier unzählige Möglichkeiten, die Schönheit und Vielfalt dieser einzigartigen Region zu erkunden.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { loriplaceMixin } from '../mixins/loriplaceMixin';

export default {
  name: 'LoriPlace',
  mixins: [loriplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Die Provinz Ararat ist Heimat einiger der bedeutendsten Kirchen Armeniens. Diese beeindruckenden Bauwerke spiegeln nicht 
        nur die tief verwurzelte religiöse Tradition wider, sondern auch die kunstvolle Architektur, die diese Region prägt.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { araratMixin } from '../mixins/araratMixin';

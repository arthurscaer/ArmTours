<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Yerevan ist vollgepackt mit interessanten Sehenswürdigkeiten! Von lebhaften Plätzen über beeindruckende Museen bis hin zu 
        lebhaften Märkten gibt es hier immer etwas zu erleben und zu entdecken.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { yerevanplaceMixin } from '../mixins/yerevanplaceMixin';

export default {
  name: 'YerevanPlace',
  mixins: [yerevanplaceMixin],
  components: {
    MenuBar,
    RatingPopup,
    CommentTeil,

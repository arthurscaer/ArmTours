<template>
  <div>
    ...
    <div class="container">
      <h1 class="intro-text">
        Kotayk ist reich an beeindruckenden Kirchen, die stolz die spirituelle und kulturelle Geschichte Armeniens verkörpern. 
        Diese faszinierenden Gotteshäuser, mit ihren einzigartigen architektonischen Stilen, bieten einen tiefen Einblick in 
        die Traditionen und Glaubensüberzeugungen der Region und laden zur Besichtigung und Besinnung ein.
      </h1>
      <div class="content">
        <div class="left-box">
...
import { kotaykMixin } from '../mixins/kotaykMixin';
